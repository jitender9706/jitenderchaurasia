...
bitnami-drupal-8.1.0-0-linux-installer.run on Linux or
bitnami-drupal-8.1.0-0-linux-x64-installer.run on Linux or
bitnami-drupal-8.1.0-0-windows-installer.exe on Windows or
bitnami-drupal-8.1.0-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-drupal-8.1.0-0-linux.run
...
Stack in /home/user/drupal-8.1.0-0 on Linux or C:\Program Files\Bitnami Drupal Stack
on Windows or /Applications/drupal-8.1.0-0 on OS X and that you use port 
...
"Cannot open bitnami-drupal-8.1.0-0-linux.run: No application suitable for
...
/Applications/drupal-8.1.0-0/apache2/logs/error.log.
